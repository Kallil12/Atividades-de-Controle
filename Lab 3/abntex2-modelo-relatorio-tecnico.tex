...
Por causa dos resultados ruins, continuamos realizando novos testes, e chegamos nos polos $0,03+0,3i$ e $0,03-0,3i$

\begin{figure}[h]
	\centering
	\includegraphics[scale=0.40]{imagens/3b_niveis_4.png}
	\caption{Gráfico do erro}
	\label{fig:erro_3b_4}
\end{figure}
